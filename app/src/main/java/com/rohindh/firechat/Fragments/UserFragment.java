...
public class UserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.user_fragement_recyclerview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        searchEt = view.findViewById(R.id.user_fragement_search);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    assert fuser != null;
                    if (!usermodel.getUserid().equals(fuser.getUid())) {
                        userList.add(usermodel);
                    }
                }
                userAdapter = new UserAdapter(userList, getContext(), false);
